function output = singlePulse_stimulation_analysis(individual_traces, time, RsStart)
...
stp_duration=stp_duration*10000;%multiplied by sampling rate
RsStart=RsStart(1,1);
RsStart=RsStart*10000;
