classdef BasicEphysAnalysisGUI < handle
    ...
    methods
        function self = BasicEphysAnalysisGUI
            ...
            self.DataAxis = subplot('Position',[245/figureWidth 50/figureHeight 540/figureWidth 365/figureHeight]);
            ...
            uicontrol(self.Figure,                                  ...
                ...
                'Position', [245/figureWidth 465/figureHeight 540/figureWidth 25/figureHeight],       ...
            ...
            self.createChoiceSliderPanel(self.Figure,@() numel(self.DialogSelectedTraceIndices),'trace',    ...
                [195/figureWidth 445/figureHeight 50/figureWidth 15/figureHeight;   ...
                 195/figureWidth 420/figureHeight 50/figureWidth 15/figureHeight],  ...
                [245/figureWidth 445/figureHeight 520/figureWidth 15/figureHeight;  ...
                 245/figureWidth 420/figureHeight 520/figureWidth 15/figureHeight], ...
                [770/figureWidth 445/figureHeight 15/figureWidth 15/figureHeight;   ...
                 770/figureWidth 420/figureHeight 15/figureWidth 15/figureHeight],  ...
                'normalized',                                                       ...
                @self.updateSelectedTraces                                          ...
                );
        end
        ...
        function chooseTraces(self,fig)
            ...
            self.DialogSelectedTraceIndices = selectedTraceIndices;
        ...
        function updateSelectedTraces(self,firstTrace,lastTrace)
            ...
            self.SelectedTraceIndices = self.DialogSelectedTraceIndices(firstTrace:lastTrace);
            self.SelectedTraces = self.AllTraces(:,self.SelectedTraceIndices);
            self.SelectedTraceNames = self.TraceNames(1,self.SelectedTraceIndices);
        ...
        function loadFiles(self)
            ...
            self.DialogSelectedTraceIndices = self.SelectedTraceIndices;
        ...
        function createChoiceSliderPanel(~,fig,nChoicesFun,tagPrefix,labelPositions,sliderPositions,counterPositions,units,callback)
            if nargin < 5
                figurePosition = get(fig,'Position');
                figureWidth = figurePosition(3);
                figureHeight = figurePosition(4);
            
                labelPositions = [20 figureHeight-70-30 50 25; 20 figureHeight-70-30-40 50 25];
                sliderPositions = [70 figureHeight-70-30 figureWidth-100 25; 70 figureHeight-70-30-40 figureWidth-100 25];
                counterPositions = [figureWidth-45 figureHeight-70-30 25 25; figureWidth-45 figureHeight-70-30-40 25 25];
                units = 'pixels';
                callback = @(varargin) 1;
            end
            
            nChoices = nChoicesFun();
            ...
            firstSlider = uicontrol(fig,                                            ...
                ...
                'Max',          max(1,nChoices),                                  ...
                'Value',        1,                                                  ...
                'SliderStep',   min(1,max(0,[1/(nChoices-1) 10/(nChoices-1)])),     ... 
                'Tag',          sprintf('first%sslider',tagPrefix),                 ...
                'Units',        units,                                              ...
                'Position',     sliderPositions(1,:)                                ...
                );
            
            firstText = uicontrol(fig,                                              ...
                'Style',        'text',                                             ...
                'String',       '1',                                                ...
                'Tag',          sprintf('first%stextafter',tagPrefix),              ...
                'Units',        units,                                              ...
                'Position',     counterPositions(1,:)                               ...
                );
            ...
            lastSlider = uicontrol(fig,                                             ...
                ...
                'Min',          1,                                                  ...
                'Max',          max(1,nChoices),                                    ...
                'Value',        max(1,nChoices),                                    ...
                'SliderStep',   min(1,max(0,[1/(nChoices-1) 10/(nChoices-1)])),     ...
                'Tag',          sprintf('last%sslider',tagPrefix),                  ...
                'Units',        units,                                              ...
                'Position',     sliderPositions(2,:)                                ...
                );
            
            lastText = uicontrol(fig,                                               ...
                'Style',        'text',                                             ...
                'String',       num2str(get(lastSlider,'Value')),                   ...
                'Tag',          sprintf('last%stextafter',tagPrefix),               ...
                'Units',        units,                                              ...
                'Position',     counterPositions(2,:)                               ...
                );
            
            function updateSliders(thisSlider,thisText,otherSlider,otherText,nChoicesFun,callback)
                thisValue = round(get(thisSlider,'Value'));
                
                set(thisSlider,'Value',thisValue);
                
                numberOfChoices = nChoicesFun(); % Matlab is too dumb to work out it doesn't cross the scope if you declare a variable with the same name in the inner function
                
                if strncmpi(get(thisSlider,'Tag'),'first',5)
                    set(thisSlider,'Max',min(thisValue+1,numberOfChoices));
                    
                    set(otherSlider,'Min',min(max(1,thisValue-1),numberOfChoices));
                    
                    if get(otherSlider,'Value') < thisValue
                        set(otherSlider,'Value',thisValue);
                    end
                else
                    set(thisSlider,'Min',max(1,thisValue-1));
                    
                    set(otherSlider,'Max',max(1,min(numberOfChoices,thisValue+1)));
                ...
                otherValue = round(get(otherSlider,'Value'));
                set(otherText,'String',num2str(otherValue));
                
                callback(thisValue,otherValue);
            end

            set(firstSlider,'Callback',@(varargin) updateSliders(firstSlider,firstText,lastSlider,lastText,nChoicesFun,callback));
            set(lastSlider,'Callback',@(varargin) updateSliders(lastSlider,lastText,firstSlider,firstText,nChoicesFun,callback));
        end
        ...
        function updateSliders(self)
            firstTraceSlider = findobj(self.Figure,'Tag','firsttraceslider');
            nTraces = max(1,numel(self.DialogSelectedTraceIndices));
            
            set(firstTraceSlider,'Min',1,'Max',nTraces,'Value',1);
            
            if get(firstTraceSlider,'Min') >= get(firstTraceSlider,'Max')
                set(firstTraceSlider,'Enable','off');
            else
                set(firstTraceSlider,'Enable','on');
            end
                
            set(findobj(self.Figure,'Tag','firsttracetextafter'),'String','1');
            
            lastTraceSlider = findobj(self.Figure,'Tag','lasttraceslider');
            
            set(lastTraceSlider,'Min',1,'Max',nTraces,'Value',nTraces);
            
            if get(lastTraceSlider,'Min') >= get(lastTraceSlider,'Max')
                set(lastTraceSlider,'Enable','off');
            else
                set(lastTraceSlider,'Enable','on');
            end
            
            set(findobj(self.Figure,'Tag','lasttracetextafter'),'String',sprintf('%d',nTraces));
        end
