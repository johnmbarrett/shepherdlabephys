...
%                 );
        ...
        function createChoiceSliderPanel(self,fig,nChoices,dims,tagPrefix)
            ...
            function updateFirstSlider(varargin)
                firstValue = get(firstSlider,'Value');
                
                set(lastSlider,'Min',min(firstValue+1,nChoices));
                set(firstText,'String',num2str(firstValue));
                set(lastText,'String',num2str(get(lastSlider,'Value')));
            end
            
            set(firstSlider,'Callback',@updateFirstSlider);
            
            function updateLastSlider(varargin)
                lastValue = get(lastSlider,'Value');
                
                set(firstSlider,'Max',max(lastValue-1,1));
                set(lastText,'String',num2str(lastValue));
                set(firstText,'String',num2str(get(firstSlider,'Value')));
            end
            
            set(lastSlider,'Callback',@updateLastSlider);
        end
